        ...
        <div class="nav-bar">
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <a href="../cadastro/index.html">Link 1</a>
                    <a href="#">Link 2</a>
                    <a href="#">Link 3</a>
                    </div>
                </li>
            ...
            <form class="formLogin" action="" method="post">
                ...
                <div class="container-input">
                    ...
                    <div class="forgotPass">
                        <a class="aItems" href="#">Esqueceu a senha?</a>
                    </div>
                </div>
                <div class="container-input button-alinha">
                    <button type="submit" name="entrar" id="entrar">ENTRAR</button>
                    <a class="aItems" href="#">Não possui uma conta?</a>
                </div>
            </form>
        </div>
    </main>
